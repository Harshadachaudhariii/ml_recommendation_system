...
The system uses a dataset of 10,000 movies. I performed data cleaning to handle missing values in genres and overviews and selected key features (id, title, genre, overview) for the model.

# Feature Engineering
To find similarities, I created a "Tags" system:
Combined the overview and genre columns into a single string for each movie.
Used CountVectorizer to convert these text tags into 10,000-dimensional vectors, removing English stop words to focus on meaningful content.
